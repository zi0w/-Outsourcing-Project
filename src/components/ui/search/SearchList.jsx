const SearchList = ({ restaurant, setSelectedRestaurant }) => {
  return (
    <li
      onClick={() => setSelectedRestaurant(restaurant)}
      className="w-full h-[100px] border drop-shadow-md rounded-[16px] bg-white flex flex-row p-5 cursor-pointer transition-transform hover:-translate-y-1 duration-500 items-center justify-between"
    >
      <div>
